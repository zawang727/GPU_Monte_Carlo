...
GPUMC_20190115.o:GPUMC_20190115.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

GPUMC_20190115: GPUMC_20190115.o
...
clean:
	rm -f GPUMC_20190115 GPUMC_20190115.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/GPUMC_20190115
